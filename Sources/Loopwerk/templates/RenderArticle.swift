  ...
  return baseLayout(canocicalURL: context.item.url, section: .articles, title: context.item.title, extraHeader: extraHeader) {
    article(class: "prose", customAttributes: ["data-pagefind-body": "data-pagefind-body"]) {
      ...
      if let heroImage = context.item.metadata.heroImage {
        ...
        img(
          alt: "Hero image",
          class: "hero-image shadow-lg shadow-shadowbg rounded-md bg-code",
    ...
    div(class: "border-t-2 border-divider mt-12 pt-12") {
      ...
      div(class: "flex flex-col lg:flex-row gap-8 lg:items-center") {
        ...
        div(class: "prose") {
          ...
          p(class: "text-secondarytext secondarytext-links text-base") {
            "I'm a product-minded senior software engineer with over 25 years of experience. I write articles about Swift, Python, and TypeScript. I've worked on "
