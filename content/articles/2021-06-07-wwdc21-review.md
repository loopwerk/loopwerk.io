...
## FaceTime
I almost never ever use FaceTime - maybe once or twice a year with my mom, and that's literally it. During COVID my Dungeons and Dragons sessions have moved online, and our group uses Google Meets. With a client I'm working for we use Zoom, and with my mentees I use [Pop](https://pop.com) (formally Screen).

It seems that many of the reason why I never use FaceTime have been addressed this WWDC: you can now create links to share in sms, email or calendar invites, just like with Google Meet, Zoom and Pop. You can view a grid of all participants, which I how I always set up Meet and Zoom as well. You can finally share your screen, so it now becomes a valid tool when pair programming remotely. And most importantly: anyone can join via the web, even people on Android and Windows pcs. Nice!
...
Will this make me start using FaceTime more? To be honest, I doubt it, but it's definitely a better chance now.
...
New Memoji outfits: whoopdeedoo?

I would've much rather seen improvements to the pretty horrible UX of the Messages app - I still struggle with all the features they cramped into that app. And why are Memoji still not available in a stand-alone app? Missed opportunity.
...
## Safari
Safari gets a big visual overhaul across iOS, iPadOS and macOS, and I have mixed feelings. On macOS and iPadOS it looks best with the new tab bar, but I am not sure if a tab bar that keeps moving around when you switch tabs is going to be annoying or not.

On iOS, I am really not a fan of the new design. Having the address bar at the bottom makes is easier to access, yes, but the new gestures seem problematic to me, since they are so close to the normal system gestures to go back to the homescreen or to swipe between apps. 

I also wonder how websites are supposed to handle the new design of the tab bar. Do we now have to deal with top and bottom "safe area insets" just like notched iPhones?
