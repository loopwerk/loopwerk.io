...
The documentation for [Saga](https://getsaga.dev), and many other Swift projects (including most of Apple's own projects), is created using [DocC](https://www.swift.org/documentation/docc/), Apple's documentation compiler. It takes your annotated source code, supplementary documents you write in markdown, and even interactive tutorials you can create using markdown, and makes this documentation available within Xcode. Better yet; it can also create an HTML version with the same look and feel as official Apple documentation, which you can host pretty much anywhere, even on GitHub Pages.
