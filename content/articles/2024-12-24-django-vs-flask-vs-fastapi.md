...
I also don’t really want to use two different systems; FastAPI for APIs and Django (or Flask) for websites. I really prefer to use one tool for all my Python needs.
