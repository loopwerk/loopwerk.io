...
[Saga](https://getsaga.dev) is my static site generator written in Swift. With version 3, the focus is on performance and extensibility.
...
[Parsley](https://github.com/loopwerk/Parsley) is my Markdown parser, and version 1.2 introduces support for adding attributes to Markdown elements using curly braces `{...}`.
